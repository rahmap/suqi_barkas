        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Mengupdate Admin</h4>
                            <p class="card-title-desc">Mengupdate Admin Toko untuk mengelola Toko.</p>

                            <form class="needs-validation" action="<?= route('admin.update', ['admin' => $admin['id']]) ?>" method="post">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="col-md-6 mb-6">
                                        ...
                                        <input type="text" id="nama" class="form-control @error('nama') is-invalid @enderror"
                                               name="nama" minlength="3" maxlength="20" placeholder="Sutijo.." value="{{ old('nama', $admin['nama']) }}" required>
                                            @error('nama')
                                    ...
                                    <div class="col-md-6 mb-6">
                                        ...
                                        <input type="email" id="email" class="form-control @error('email') is-invalid @enderror"
                                               name="email" placeholder="admin1@gamail.com" value="{{ old('email', $admin['email']) }}" required>
                                            @error('email')
                                            <div class="invalid-feedback">
                                              {{ $message }}
                                            </div>
